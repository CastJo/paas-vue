<template>
    <div id="main">
<!--      返回按钮-->
        <el-button type="info" icon="el-icon-back" style="margin-left: 50px;margin-top: 20px;" @click="cancel">返回</el-button>
<!--      标题  -->
...
//判断必填的端口号是否已经填写
                ...
                if (this.container.env.length>0) {
                    for (i = 0; i < this.container.env.length; i++) {
                ...
                if (this.container.cmd.length>0){
                    for(i = 0; i < this.container.cmd.length; i++){
                ...
                if (this.container.destination.length>0){
                    for(i = 0; i < this.container.destination.length; i++){
                ...
                if (this.container.port.length > 0) {
                    ...
                    for (i = 0; i < this.container.port.length; i++) {
                ...
                let portMap = {}
                this.container.port.forEach((item) => {
